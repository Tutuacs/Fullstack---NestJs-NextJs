      ...
      <div className="flex flex-col min-h-full mb-10">
        <section className="w-full">
          <div className="flex flex-col items-center bg-gray-200">
            <Image src="/banner.png" alt="home" width={1200} height={300} />
              ...
              <div className="flex flex-col items-center md:flex-row">
                ...
                <div className="w-full p-4 md:w-3/4">
                  <p className="text-justify">
                    ...
                    atua no mercado há 33 anos, quando elegeu a linha de
                    veículos pesados da Volkswagen, como seu principal foco de
                    trabalho. Essa visão estratégica, que antecipava o
                    crescimento da Volkswagen como líder da frota nacional de
                    caminhões, permitiu à<strong> MORELATE </strong>
                    consolidar-se como expoente sólido desse segmento, criando
                    uma imagem de qualidade de atendimento a preços
                    competitivos.
                  </p>
                </div>
              </div>
            ...
            <div className="w-8/12 p-4 m-2 bg-white rounded shadow">
              <p className="text-justify">
                ...
                <strong> MORELATE </strong>
                está localizado no município de São Paulo, próximo ao eixo
                rodoviário da Anhanguera, com uma área construída de 20.000 m²,
                própria, que abriga escritórios, garagens e estoques, além de
                uma central de atendimento, compras e vendas. Seus estoques
                abrigam mais de 80.000 itens, o que exige uma ampla gama de
                fornecedores, permitindo o atendimento imediato da maioria das
                marcas e modelos de caminhões pesados e médios comercializados
                no Brasil. Sua equipe de 240 colaboradores mescla profissionais
                experientes com jovens talentos, garantindo a continuidade de um
                conhecimento especializado, por tipos e marcas de veículos, em
                uma constante atualização e inovação.
              </p>
            </div>
            ...
            <div className="w-8/12 p-4 m-2 bg-white rounded shadow">
              ...
              <div className="flex flex-wrap mt-4 text-center">
                <div className="w-full p-2 md:w-1/3">
                  ...
                  <p className="text-sm">
                    Atender nossos clientes na produção e comercialização de
                    peças para o segmento de veículos utilitários, médios,
                    semipesados e pesados, com preços competitivos, qualidade
                    superior, excelência nos serviços e eficiência no pós-venda,
                    maximizando valor para nossos clientes, funcionários e
                    acionistas.
                  </p>
                </div>
                <div className="w-full p-2 md:w-1/3">
                  ...
                  <p className="text-sm">
                    Ser empresa e uma marca de referência, reconhecida como a
                    melhor opção por clientes, colaboradores, comunidade,
                    fornecedores e investidores, devido à qualidade de nossos
                    produtos, serviços e relacionamento, implementando
                    constantemente soluções técnicas para nosso segmento.
                  </p>
                </div>
                <div className="w-full p-2 md:w-1/3">
            ...
            <div className="w-8/12 p-4 m-2 bg-white rounded shadow">
              ...
              <p className="mt-4 text-justify">
                ...
                comercialização de autopeças nacionais e importadas para o
                segmento de veículos utilitários, médios, semipesados e pesados
                estabelecem os seguintes princípios:
              </p>
              <ul className="mt-2 list-disc list-inside">
                <li>
                  Atender as necessidades dos clientes de forma eficaz e
                  satisfatória, bem como outros requisitos aplicáveis.
                </li>
                <li>Promover a melhoria contínua.</li>
                <li>
                  Definir os objetivos da qualidade e trabalhar para atingi-los
                  através dos nossos recursos e especialmente através das
            ...
            <div className="w-8/12 p-4 m-2 bg-white rounded shadow">
              <p className="text-justify">
                ...
                possibilitou participar do fornecimento de outras marcas, tais
                como Ford, Scania, Mercedes, Volvo e Agrale, elevando a{" "}
                <strong>MORELATE</strong>, nos últimos dez anos, às cinco
                maiores do seu segmento, em toda a América do Sul. Com uma
                sólida estrutura, a <strong>MORELATE</strong> possui atualmente
                9 unidades de distribuição (CDs) onde atende todo o território
                nacional e sul americano, confira abaixo:
              </p>
            </div>
            ...
            {[
              ...
              <div
                key={index}
                className="w-8/12 p-4 m-2 bg-white rounded shadow"
              >
